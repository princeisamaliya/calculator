...
class Calculator extends Component {
  ...
  handleNumbers(e){
    this.setState({ currentVal:  this.state.currentVal == '0' ? e.target.value : this.state.currentVal + e.target.value});
...
class Buttons extends Component{
  ...
  render(){
    return(
      <div >
        <button  onClick={this.props.initialize}  id="clear" value="ac">AC</button>
        <button id="divide" value="/">/</button>
        <button id="multiply" value="*">*</button>
        <button onClick={this.props.numbers}  id="seven" value="7">7</button>
        <button onClick={this.props.numbers} id="eight" value="8">8</button>
